...
ln -s "${src_path}/linux/${new_kernel_ver}/" "/usr/src/linux" || { echo "Error creating symlink to new kotori linux source directory."; exit 1; }
echo "Sucessfully created /usr/src/linux symlink to ${src_path}/linux/${new_kernel_ver} \n"
